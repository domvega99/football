...
@Component({
  ...
  templateUrl: './cup-add-edit.component.html',
  styleUrl: './cup-add-edit.component.sass'
})
export class CupAddEditComponent {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<CupAddEditComponent>,
