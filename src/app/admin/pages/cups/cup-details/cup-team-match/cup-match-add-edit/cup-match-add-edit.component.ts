...
@Component({
  selector: 'app-cup-match-add-edit',
  standalone: true,
  imports: [
    MatButtonModule, 
    MatDialogModule, 
  ...
  templateUrl: './cup-match-add-edit.component.html',
  styleUrl: './cup-match-add-edit.component.sass'
})
export class CupMatchAddEditComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CupMatchAddEditComponent>,
