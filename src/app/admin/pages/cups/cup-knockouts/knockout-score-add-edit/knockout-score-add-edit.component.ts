...
@Component({
  ...
  templateUrl: './knockout-score-add-edit.component.html',
  styleUrl: './knockout-score-add-edit.component.sass'
})
export class KnockoutScoreAddEditComponent {
  teams: any[] = [];
  playerScores: any[] = [];
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<KnockoutScoreAddEditComponent>,
